    ...
    <div className="flex h-10">
      <div className="flex-grow p-3 ">
        <div className="flex items-center gap-2 text-primary-text-color p-2 font-bold">
          ...
          <h3>SIte Setup : Mid Grade Setup</h3>
        </div>
        <div className="flex">
              ...
              <form className="grid grid-cols-6 gap-6">
                ...
                <div className="col-span-1">
                  ...
                  <input
                    ...
                    name="Zip Code"
                    id="Zip Code"
                    className="w-full border-2 rounded-lg py-1.5 px-3 focus:outline-none focus:border-violet-400 focus:ring-violet-400 block focus:ring-3"
